...
class App extends React.Component {
    ...
    getImageUrl = (index) => {
        return `https://placeimg.com/640/480/animals/${index}`;
    };
        ...
        if (isDone) {
            ...
            return (
                <div className='app-container'>
                    ...
                    <img alt='Random Picsum' src={imageUrl} />
                    <div className='button-row'>
                        <ButtonComponent
                            label='dislike'
                            parentClickHandler={this.handleRejectClick}
                        />
                        <ButtonComponent
                            label='like'
                            parentClickHandler={this.handleApproveClick}
                        />
                    </div>
                </div>
            );
